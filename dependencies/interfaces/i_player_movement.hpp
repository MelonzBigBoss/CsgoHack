...
public:
	void update(int start_frame, bool valid_frame, int incoming_ack, int outgoing_cmd) {
		typedef void(__thiscall* o_run_command)(void*, int, bool, int, int);
		return utilities::call_virtual<o_run_command>(this, 3)(this, start_frame, valid_frame, incoming_ack, outgoing_cmd);
	}
