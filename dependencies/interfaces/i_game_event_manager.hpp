...
public:
	...
	virtual const void*		get_ptr(const char* name = nullptr) const = 0;
	...
	virtual bool            for_event_data(void* name) const = 0;
};
...
public:
	...
	virtual void        add_listener_global(i_game_event_listener2* listener, bool serverside) = 0;
