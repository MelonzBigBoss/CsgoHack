...
class i_mdl_cache : public IAppSystem
{
public:
	...
	virtual studio_hdr_t* GetStudioHdr(MDLHandle_t hModel) = 0;
	virtual studiohwdata_t* GetHardwareData(MDLHandle_t hModel) = 0;
	virtual void* GetVCollide(MDLHandle_t hModel) = 0;
	virtual void* GetVCollide(MDLHandle_t hModel, float flScale) = 0;
	...
	virtual void* GetVirtualModel(MDLHandle_t hModel) = 0;
	...
	virtual void* GetVirtualModelFast(const studio_hdr_t* pStudioHdr, MDLHandle_t hModel) = 0;
	virtual void BeginLock() = 0;
	virtual void EndLock() = 0;
	virtual int* GetFrameUnlockCounterPtrOLD() = 0;
	virtual void FinishPendingLoads() = 0;
	virtual void* GetVCollideEx(MDLHandle_t hModel, bool bSynchronousLoad = true) = 0;
	...
	virtual studio_hdr_t* LockStudioHdr(MDLHandle_t hModel) = 0;
	...
	virtual bool SetCombineModels(MDLHandle_t hModel, const utl_vector<void*>& vecModelsToCombine) = 0;
	...
	virtual c_key_values* GetCombinedMaterialKV(MDLHandle_t hModel, int nAtlasGroup = 0) = 0;
