...
#include "i_physics_props.hpp"
#include "i_view_render.hpp"
#include "i_view_render_beam.hpp"
#include "i_mdl_cache.hpp"
#include "i_key_value_system.hpp"
#include "i_network_container.hpp"
...
namespace interfaces {
	...
	inline i_physics_props* physics_props;
	inline i_view_render* view_render;
	inline i_view_render_beam* view_render_beam;
	inline i_mdl_cache* mdl_cache;
	inline i_key_value_system* key_value_system;
	inline i_network_container* network_container;
