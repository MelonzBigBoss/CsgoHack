...
class i_network_string_container;
using string_changed_fn = void(__cdecl*)(void*, i_network_string_container*, int, char const*, void const*);

class i_network_string_container
{
public:
	virtual					~i_network_string_container() { }
	...
	virtual void			SetStringChangedCallback(void* pObject, string_changed_fn changeFunc) = 0;
};

class i_network_container
{
public:
	i_network_string_container* FindTable(const char* szTableName)
	{
		using VirtualFn = i_network_string_container*(__thiscall*)(void*, decltype(szTableName));
		return (*(VirtualFn**)(this))[3](this, szTableName);
	}
};
