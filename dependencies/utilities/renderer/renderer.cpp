...
void render::initialize() {
	...
	interfaces::surface->set_font_glyph(render::fonts::small_font, "Tahoma", 10, 500, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::weapon_font, "AstriumWep", 20, 500, 0, 0, font_flags::fontflag_dropshadow);
