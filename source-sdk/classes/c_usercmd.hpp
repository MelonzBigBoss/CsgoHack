...
namespace CRC32
{
	...
	constexpr CRC32_t pulCRCTable[256] =
	{
	...
	inline void Init(CRC32_t* pulCRC)
	{
		*pulCRC = 0xFFFFFFFFUL;
	}
	inline void Final(CRC32_t* pulCRC)
	{
		*pulCRC ^= 0xFFFFFFFFUL;
	}
	inline void ProcessBuffer(CRC32_t* pulCRC, const void* pBuffer, int nBuffer)
	{
...
struct c_usercmd {
	...
	short mousedy;
	bool predicted;
	vec3_t vecheadangles;
	vec3_t vecheadoffset;
